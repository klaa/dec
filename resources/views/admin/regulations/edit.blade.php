...
@section('pagetitle',__('admin.regulation_edit'))
...
@section('content')
<form action="{{ route('admin.regulations.update',$post) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="card shadow mb-4">
        ...
        <div class="card-footer">
            ...
            <a href="{{ route('admin.regulations.index') }}" class="btn btn-warning"><i class="far fa-window-close text-white-50"></i> {{ __('admin.cancel') }}</a>
        </div>
    </div>
</form>
@endsection