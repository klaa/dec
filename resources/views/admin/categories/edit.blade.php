...
<form action="{{ route($routeList['update'],$category) }}" method="POST">
    ...
    <div class="card shadow mb-4">
                ...
                <div class="col form-group">
                    ...
                    <div class="form-control border-0">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="published" id="publishYes" value="1" @if($category->published==1) checked @endif>
                            <label class="form-check-label" for="publishYes">{{ __('admin.yes') }}</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="published" id="publishNo" value="0" @if($category->published==0) checked @endif>
        ...
        <div class="card-footer">
            ...
            <a href="{{ route($routeList['index'],['type'=>$category->category_type]) }}" class="btn btn-warning"><i class="far fa-window-close text-white-50"></i> {{ __('admin.cancel') }}</a>
        </div>
    </div>
</form>
@endsection