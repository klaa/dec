...
@section('content')
<form action="{{ route($routeList['store'],['type'=>request()->get('type','post')]) }}" method="POST">
    @csrf
    <div class="card shadow mb-4">
        ...
        <div class="card-footer">
            ...
            <a href="{{ route($routeList['index'],['type'=>request()->get('type','post')]) }}" class="btn btn-warning"><i class="far fa-window-close text-white-50"></i> {{ __('admin.cancel') }}</a>
        </div>
    </div>
</form>
@endsection